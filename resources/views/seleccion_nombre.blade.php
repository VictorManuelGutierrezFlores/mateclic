...
<div class="absolute bottom-0 w-full h-full" style="background-image:url(/img/fondos/fondo2.svg); background-size: 100%; background-position:bottom; background-repeat: no-repeat;">
    <div class="grid grid-cols-3 grid-rows-2">
            ...
            <div class="col-start-2 row-start-2 pt-14 h-32">
                <div class="rounded-xl max-w-sm mx-auto bg-[#8afad9] p-9 transition ease-in-out delay-100 hover:-translate-1 hover:scale-110 hover:bg-[#00faaf] duration-300">
                    <input class="text-center block w-full rounded-md font-just text-2xl text-black placeholder-black" placeholder="Inserte nombre" style="background-color:transparent;" name="equipo" value=""></input>
                </div>
            </div>
